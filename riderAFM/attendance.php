...
<body onload="getLocation()" class="hold-transition sidebar-mini layout-fixed">
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="badge badge-primary text-wrap" style="color:white;width: 6rem;"><?php echo $row_Recordset['nama'];?></a>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form action="insert_update_delete.php" method="post">
               ...
               <div class="table-responsive">
                  <?php if (! empty ($row_Recordset2['timeOut'] || $row_Recordset2['timeOut'] == NULL)) {echo '<input type="submit" name="update" class="btn btn-warning btn-block btn-flat" data-toggle="modal" data-target="#modal-success" value= "Clock-Out"/>';}?>
                </div>
                <!-- /.table-responsive -->
