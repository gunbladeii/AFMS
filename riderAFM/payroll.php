  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="profileRider.php" class="badge badge-primary text-wrap" style="color:white;width: 6rem;"><?php echo ucwords($row_Recordset['nama']);?></a>
        </div>
      </div>
...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-light">
            <div class="modal-header">
              <h4 class="modal-title">Rider Payment Voucher Record</h4>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Payment voucher record for rider</h3>
            </div>
            <!-- /.card-header -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019 <a href="https://iberkat.tech/afm">iBerkat Sdn. Bhd</a>.</strong>
    All rights reserved.
