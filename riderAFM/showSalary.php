...
<?php if ($BC['employeeStatus'] != 'temp' && $AC > 0){?>
            ...
            <table id="example2" class="table table-sm table-hover table-responsive-sm">
                ...
                <td>1</td>
                <td>Penalty</td>
                <td style="text-align:right"><span id = "penalty" class="btn btn-light btn-sm btn-block"><?php echo $penalty;?></span></td>
                <!--deductions-->
	            </tr>
                ...
                <td>4</td>
                <td>Comission</td>
                <td style="text-align:right"><span id = "comission" class="btn btn-light btn-sm btn-block"><?php if($formCommision3 > 0){echo $formCommision3;}else{echo 0;};?></span></td>
                <!--earnings-->
                <td>4</td>
                <td>SOCSO</td>
...
<?php if ($BC['employeeStatus'] == 'temp' && $AC > 0){?>
           ...
           <div style="text-align:center; padding:3px"><button class="btn btn-outline-dark btn-sm btn-block"><?php $monthM=date_create($AC['date']);echo 'Month of '.date_format($monthM,"F,Y");?></button></div>
            ...
            <table id="example2" class="table table-hover table-responsive-xl">
                ...
                <td>7</td>
                <td>Att Allowance</td>
                <td style="text-align:right"><span id="attAllow" class="btn btn-light btn-sm btn-block"><?php if ($totalAttend > 26){echo $attAllow;}else{echo 0;}?></span></td>
                <!--earnings-->
                <td style="text-align:right"></td>
                <td style="text-align:right"></td>
                <td style="text-align:right"></td>
                ...
                <tr style="text-align:center">
                  <th class="table-info" colspan="2">Total Earnings</th>
                  <th class="table-info" style="text-align:right"><span class="btn btn-light btn-sm btn-block"><?php if ($totalAttend > 26){echo $totalEarning2;}else{echo $totalEarning1;}?></span></th>
                  <th class="table-warning" colspan="2">Total Deductions</th>
