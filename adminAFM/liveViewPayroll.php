...
<?php if(!empty($row_Recordset2['stationCode'])) {?>
              ...
              <table id="example2" class="table table-hover table-responsive-xl">
                ...
                <tr>
                <td><?php echo $a++;?></td>	
	            <td> <span data-toggle="modal" data-target="#viewRiderModal" data-whatever="<?php echo $row_Recordset2['noIC'];?>" data-whatever2="<?php echo $row_Recordset2['month'];?>" class="badge badge-primary" role="button" aria-pressed="true"><?php echo strtoupper($row_Recordset2['nama']);?></span></td>	
