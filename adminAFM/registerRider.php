        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">AFMS | Register</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<section class="content">
  <div class="register-logo">
    <a href="index.php"><img src="altus logo.png" style="width:15%"></a>
  </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Registered Rider/SV <p class="h6"></p>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
...
<!--deleteStaffModal-->
<div class="modal fade" id="deleteStaffModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<!-- end / deleteStaffModal-->

 <!--parcelModal-->
<div class="modal fade" id="parcelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Register New Rider</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script>
    ...
    $('#deleteStaffModal').on('show.bs.modal', function (event) {
          ...
          var modal = $(this);
          var dataString2 = 'noIC=' + recipient2;
