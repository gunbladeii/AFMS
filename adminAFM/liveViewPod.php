...
<?php if(!empty($row_Recordset2['stationCode'])) {?>    
              ...
              <table id="example3" class="table table-hover table-responsive">
                ...
                <tr style="text-align:center">
                <td><?php echo $a++;?></td>	
                <td> <span data-toggle="modal" data-target="#viewRiderModal" data-whatever="<?php echo $row_Recordset2['id'];?>" class="close badge badge-primary" data-dismiss="modal" role="button" aria-pressed="true"><?php echo ucwords($row_Recordset2['id']);?></span></td> 
