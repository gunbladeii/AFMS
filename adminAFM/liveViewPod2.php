...
<form method="post" action="liveViewinfoParcel2.php" role="form" enctype="multipart/form-data">
       ...
       <!--BEGIN CLASS tab-pane-->
        ...
        <div class="form-group">
          <div class="input-group mb-3"> 
          <input type="text" name="itemCode" class="form-control" placeholder="Parcel Received" id="validationDefault04" value="<?php echo $ED['itemCode'];?>" required>
          <div class="input-group-append input-group-text">
        ...
        <div class="form-group">
          <div class="input-group mb-3"> 
          <input type="text" name="fail" class="form-control" placeholder="Undel" id="validationDefault04" value="<?php echo $ED['fail'];?>" required>
          <div class="input-group-append input-group-text">
              <span class="fas fa-user-clock"></span>
          </div>
          </div>
        ...
        <div class="modal-footer">
         <input type="submit" class="btn btn-primary" name="submit" value="Edit Parcel Record"/>&nbsp;
