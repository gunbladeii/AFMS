      ...
      <img src="data:image/jpeg;base64,<?php echo base64_encode($ED['riderFacePic']);?>" class="brand-image img-circle elevation-5"
       ...
       <!--BEGIN CLASS tab-pane-->
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                <input type='text' class="form-control" name="dateJoin" placeholder="Date of Joining(dd/mm/yyyy)" data-inputmask="'mask':['99-99-9999']" data-mask  value="<?php echo $ED['dateJoin'];?>" required/>
                <div class="input-group-append input-group-text">
                    <span class="fas fa-calendar">
                    </span>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                <input type='text' class="form-control" name="dateTransfer" placeholder="Date of Transfer(dd/mm/yyyy)" data-inputmask="'mask':['99-99-9999']" data-mask value="<?php echo $ED['dateTransfer'];?>" required/>
                <div class="input-group-append input-group-text">
                    <span class="fas fa-calendar">
                    </span>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                <input type='text' class="form-control" name="datePromo" placeholder="Date of Promo(dd/mm/yyyy)" data-inputmask="'mask':['99-99-9999']" data-mask value="<?php echo $ED['datePromo'];?>" required/>
                <div class="input-group-append input-group-text">
                    <span class="fas fa-calendar">
                    </span>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                <input type='text' class="form-control" name="dateResign" placeholder="Date of Resignation(dd/mm/yyyy)" data-inputmask="'mask':['99-99-9999']" data-mask value="<?php echo $ED['dateResign'];?>" required/>
                <div class="input-group-append input-group-text">
                    <span class="fas fa-calendar">
                    </span>
                </div>
