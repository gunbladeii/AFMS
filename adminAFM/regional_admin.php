        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">AFMS | Dashboard</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-sm-4 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header"><span class="badge badge-warning">In Progress</span></h5>
        ...
        <div class="row">
         ...
         <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
              <h3 class="card-title"><i class="fas fa-motorcycle mr-1"></i> Performance Status</h3><p class="h6">(Data Shown by Month)</p>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content p-0">
                  <!-- Morris chart - Sales -->
                  <div id="showPerfChart"></div>
                </div>
              </div><!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Revenue Indicator
                </h3><p class="h6">(Data Shown by Month)</p>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content p-0">
                  <!-- Morris chart - Sales -->
                  <div id="showRevChart"></div>
                </div>
              </div><!-- /.card-body -->
            </div>
            <!-- /.card -->
...
<script>
    $('#performanceModal').on('show.bs.modal', function (event) {
          ...
          var modal = $(this);
          var dataString = 'stationCode=' + recipient + '&' + 'month=' + recipient2 + '&' + 'year=' + recipient3;
